...
namespace Hellodit\CustomerProduct\DataGrinds;
...
class ProductDataGrind extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::table('product_flat')
            ...
            ->leftJoin('products as pd', 'pd.id', '=', 'product_flat.product_id')
            ->select(
                'product_flat.locale',
                ...
                'product_flat.type',
                'product_flat.status',
                DB::raw('FORMAT(product_flat.price,0) as price'),
//                'product_flat.price',
        ...
        $queryBuilder->where('pd.customer_id', \Auth::user()->id);
