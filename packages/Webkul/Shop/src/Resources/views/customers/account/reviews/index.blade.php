            ...
            <script type="text/x-template" id="v-product-reviews-template">
                <div>
                    ...
                    <template v-if="isLoading">
                        <x-shop::shimmer.customers.account.reviews
                            :count="4"></x-shop::shimmer.customers.account.reviews>
                    </template>
                                ...
                                @if (! $reviews->isEmpty())
                                    ...
                                    <div class="grid gap-[20px] mt-[60px] max-1060:grid-cols-[1fr]">
                                        @foreach($reviews as $review)
                                            ...
                                            >
                                                <div
                                                    class="flex gap-[20px] p-[25px] border border-[#e5e5e5] rounded-[12px] max-sm:flex-wrap">
                                                    ...
                                                    <div class="w-full">
                                                        <div class="flex justify-between">
                                                            ...
                                                            <div class="flex gap-[10px] items-center">
                                                                @for ($i = 1; $i <= 5; $i++)
                                                                    <span
                                                                        class="icon-star-fill text-[24px] {{ $review->rating >= $i ? 'text-[#ffb600]' : 'text-[#6E6E6E]' }}"></span>
                                                                @endfor
                                                            </div>
                                                        </div>
