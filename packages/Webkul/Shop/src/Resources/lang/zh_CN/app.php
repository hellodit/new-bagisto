...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© 版权所有 ©Copyright 2024, Software Pegadaian (GSI Software). All rights reserved（注册于印度）。保留所有权利。',
            'page-title'           => '忘记密码？',
        ...
        'reset-password' => [
            ...
            'email'            => '注册电子邮件',
            'footer'           => '© 版权 ©Copyright 2024, Software Pegadaian (GSI Software). All rights reserved（注册于印度）。保留所有权利。',
            'password'         => '密码',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'contact-us'             => '联系我们',
                'currency'               => '货币',
                'footer-text'            => '© 版权所有  2023，Software Pegadaian (GSI Software)（印度注册）。 保留所有权利。',
                'locale'                 => '语言',
