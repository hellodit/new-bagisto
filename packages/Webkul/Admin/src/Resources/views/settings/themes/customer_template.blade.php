<script type="text/x-template" id="v-customer-theme-template">
    <div class="flex gap-[10px] mt-[14px] max-xl:flex-wrap">
                ...
                <div class="flex gap-x-[10px] justify-between items-center mb-[10px]">
                    <div class="flex flex-col gap-[4px]">
                        ...
                        <p class="text-[12px] text-gray-500 dark:text-gray-300 font-medium">
                            Showcase Partner elegantly with a dynamic and responsive product carousel.
                        </p>
                    </div>
                </div>
        ...
        <div class="flex flex-col gap-[8px] w-[360px] max-w-full max-sm:w-full">
            <x-admin::accordion>
                ...
                <x-slot:content>
                    <input type="hidden" name="type" value="customer_carousel">
...
{{-- Partner Theme Component --}}
<script type="module">
    app.component('v-customer-theme', {
        template: '#v-customer-theme-template',
        ...
        methods: {
            addFilter(params) {
                ...
                this.$refs.customerFilterModal.toggle();
            },
