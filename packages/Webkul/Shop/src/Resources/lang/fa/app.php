...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© حق تألیف  :current_year، نرم‌افزار وب‌کول (ثبت شده در هند). تمامی حقوق محفوظ است.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© حق کپی رایت  2023، نرم‌افزار وبکول (ثبت‌شده در هند). تمامی حقوق محفوظ است.',
                'locale'                 => 'زبان و محل',
