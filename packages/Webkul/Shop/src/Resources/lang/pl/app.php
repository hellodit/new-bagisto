...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Prawa autorskie  :current_year, Software Pegadaian (GSI Software) (zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'contact-us'             => 'Kontakt',
                'currency'               => 'Waluta',
                'footer-text'            => '© Prawa autorskie  2023, Software Pegadaian (GSI Software) (Zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
                'locale'                 => 'Lokalizacja',
