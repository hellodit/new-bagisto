...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Копірайт  :current_year, Software Pegadaian (GSI Software) (зареєстрована в Індії). Всі права захищені.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Валюта',
                'footer-text'            => '© Авторські права  2023, Software Pegadaian (GSI Software) (зареєстровано в Індії). Усі права захищені.',
                'locale'                 => 'Мова',
