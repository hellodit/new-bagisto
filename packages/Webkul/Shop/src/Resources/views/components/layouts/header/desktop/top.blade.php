<div class="flex justify-between items-center w-full py-[11px] px-16 border border-t-0 border-b-[1px] border-l-0 border-r-0 max-md:hidden">
    {{-- Currency Switcher --}}
    <x-shop::dropdown>
        <!-- Dropdown Toggler -->
        <x-slot:toggle>
    ...
    <p class="text-xs font-medium">Buat Akun Baru & <a href="/customer/register" class="underline">Daftar Sekarang</a></p>
