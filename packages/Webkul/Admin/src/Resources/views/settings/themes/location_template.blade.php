<script type="text/x-template" id="v-location-theme-template">
    <div class="flex gap-[10px] mt-[14px] max-xl:flex-wrap">
        ...
        <div class="flex flex-col gap-[8px] w-[360px] max-w-full max-sm:w-full">
            <x-admin::accordion>
                ...
                <x-slot:content>
                    <input type="hidden" name="type" value="location_carousel">
...
<script type="module">
    app.component('v-location-theme', {
        template: '#v-location-theme-template',
        ...
        methods: {
            addFilter(params) {
                ...
                this.$refs.locationFilterModal.toggle();
            },
