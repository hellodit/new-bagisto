...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright  :current_year, Software Pegadaian (GSI Software) (in Indien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Währung',
                'footer-text'            => '© Copyright  2023, Software Pegadaian (GSI Software) (registriert in Indien). Alle Rechte vorbehalten.',
                'locale'                 => 'Sprache',
