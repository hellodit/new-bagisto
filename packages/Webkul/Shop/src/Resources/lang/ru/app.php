...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Авторское право  :current_year, Software Pegadaian (GSI Software) (зарегистрировано в Индии). Все права защищены.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Валюта',
                'footer-text'            => '© Авторские права  2023, Software Pegadaian (GSI Software) (зарегистрирована в Индии). Все права защищены.',
                'locale'                 => 'Язык',
